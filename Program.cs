...
namespace WebCrawlerQnA
{
    internal class Program
    {
        static async Task Main(string[] args)
        {
            ...
            buildCommand.Handler = CommandHandler.Create<string, string, int>(async (string url, string path, int rpm) =>
            {
                ...
                await TextEmbedding.CreateEmbeddings(openAiService, df, domain, rpm);
            });
